    ...
    messages: [
        {
            ...
            from: "customer",
            message:
                "Hi, I'd like to confirm that you'll be using synthetic oil for the oil change.",
        },
        {
            id: "MSG-002",
            ...
            from: "admin",
            message:
                "Yes, we'll be using synthetic oil as requested. Is there a specific brand you prefer?",
        },
        {
            id: "MSG-003",
...
export const AdminMaintenanceDetail = () => {
    ...
    const [updatedPrice, setUpdatedPrice] = useState(
        maintenanceData.price.toString()
    );
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center">
                    ...
                    <h1 className="text-2xl font-bold tracking-tight">
                        Maintenance Request {maintenanceData.id}
                    </h1>
                    <div className="ml-4">
                            ...
                            >
                                ...
                                <DialogContent>
                                    <DialogHeader>
                                        ...
                                        <DialogDescription>
                                            Confirm the details and price before
                                            approving this maintenance request.
                                        </DialogDescription>
                                    </DialogHeader>
                                ...
                                <DialogContent>
                                    <DialogHeader>
                                        ...
                                        <DialogDescription>
                                            ...
                                            rejecting this maintenance request.
                                        </DialogDescription>
                                    </DialogHeader>
                                    <div className="space-y-4 py-4">
                                        <div className="space-y-2">
                                    ...
                                    <CardContent>
                                        <div className="space-y-3">
                                            ...
                                            <Button
                                                ...
                                                onClick={() =>
                                                    navigate(
                                                        `/admin/vehicles/${maintenanceData.vehicle.id}`
                                                    )
                                                }
                                            >
                                    ...
                                    <CardContent>
                                        <div className="flex items-center gap-3 mb-4">
                                            <Avatar className="h-10 w-10">
                                                ...
                                                />
                                                <AvatarFallback>
                                                    {maintenanceData.customer.name.charAt(
                                                        0
                                                    )}
                                                </AvatarFallback>
                                            </Avatar>
                                        ...
                                        <Button
                                            ...
                                            onClick={() =>
                                                navigate(
                                                    `/admin/users/${maintenanceData.customer.id}`
                                                )
                                            }
                                        >
                        ...
                        <TabsContent value="history">
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Timeline of actions and updates for this
                                        maintenance request
                                    </CardDescription>
                                </CardHeader>
                                <CardContent>
                                    <div className="space-y-6">
                                        {maintenanceData.history.map(
                                            (item, index) => (
                                                <div
                                                    key={index}
                        ...
                        <TabsContent value="messages">
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Messages exchanged regarding this
                                        maintenance request
                                    </CardDescription>
                                </CardHeader>
                                <CardContent>
                                    <div className="space-y-4 max-h-[400px] overflow-y-auto mb-4">
                                        {maintenanceData.messages.map(
                                            (message) => (
                                                <div
                                                    key={message.id}
                                                    className={`flex ${
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <span>
                                        {formatDateTime(
                                            maintenanceData.history[0].date
                                        )}
                                    </span>
                                </div>
                                <div className="flex justify-between">
                                    ...
                                    <span>
                                        {formatDateTime(maintenanceData.date)}
                                    </span>
                                </div>
                            </div>
                        </CardContent>
