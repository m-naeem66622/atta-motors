...
const VehicleListingForm: React.FC<VehicleListingFormProps> = ({ onClose }) => {
  ...
  return (
      <div className="py-8 text-center">
        ...
        <p className="text-gray-600 mb-6">Your vehicle has been listed for sale.</p>
            ...
            <form onSubmit={form.handleSubmit(onSubmit)}>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="e.g. 2020 Toyota Camry XSE - Excellent Condition" {...field} />
                        </FormControl>
                        <FormDescription>Create a descriptive title for your listing</FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          Minimum 20 characters. Be honest about the condition of your vehicle.
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
              ...
              <TabsContent value="3">
                <div className="space-y-6">
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                    <div className="mb-4">
                      ...
                      <h3 className="mt-2 text-sm font-semibold text-gray-900">Upload Vehicle Photos</h3>
                  ...
                  {imageUrls.length > 0 && (
                    <div>
                      <h3 className="text-sm font-semibold mb-2">Uploaded Photos ({imageUrls.length})</h3>
                ...
                {imageUrls.length === 0 && (
                  <Alert>
                    <AlertDescription>
                      Listings with photos receive up to 5x more inquiries. We recommend uploading at least 5 photos of
                      your vehicle.
                    </AlertDescription>
                  </Alert>
                )}
              ...
              <TabsContent value="4">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>City and state where the vehicle is located</FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
                ...
                <Alert>
                  <AlertDescription>
                    By submitting this listing, you confirm that all information provided is accurate and that you are
                    the owner of this vehicle or authorized to sell it.
                  </AlertDescription>
                </Alert>
                </div>
              </TabsContent>
